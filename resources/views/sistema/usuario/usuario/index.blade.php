...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-4">
                {{-- Botones de acción --}}
                <x-button class="btn-success" href="{{ route('usuarios.create') }}" title="Nuevo"><i class="fas fa-plus-circle"></i> Nuevo</x-button>
            ...
            <div class="col-sm-8">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active text-bold">Usuarios</li>
                </ol>
            </div>
        </div>
    </div>
...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                @livewire('sistema.usuario.usuario.index-component')
            </div>
        </div>
    </div>
</section>
