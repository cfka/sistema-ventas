...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-4">
                {{-- Botones de acción --}}
                <x-button class="btn-success" href="{{ route('proveedores.create') }}" title="Nuevo"><i class="fas fa-plus-circle"></i> Nuevo</x-button>
...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                @livewire('sistema.producto.proveedor.index-component')
            </div>
        </div>
    </div>
</section>
